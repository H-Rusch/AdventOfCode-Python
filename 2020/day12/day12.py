...
def part1(direction_list: list):
    ...
    print("The Manhatten distance is {}\n".format(str(abs(ship_position[0]) + abs(ship_position[1]))))


def part2(direction_list: list):
    ...
    for direct in direction_list:
        ...
        # move towards the relative position of the waypoint
            ...
            x_new = position_waypoint[0] * int(math.cos(degree)) - position_waypoint[1] * int(math.sin(degree))
            y_new = position_waypoint[1] * int(math.cos(degree)) + position_waypoint[0] * int(math.sin(degree))
    ...
    print("The Manhatten distance is {}\n".format(str(abs(position_ship[0]) + abs(position_ship[1]))))


# read in directions
with open("input.txt", "r") as file:
    directions = [direct for direct in file.read().split("\n")]
