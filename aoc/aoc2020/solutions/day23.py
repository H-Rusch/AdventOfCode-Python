...
def part1(input):
    ...
    for _ in range(100):
        ...
        picked_up = [
            pick_up_start.value,
            pick_up_start.next.value,
            pick_up_start.next.next.value,
        ]
...
def part2(input):
    ...
    return ones_cup.next.next.value * ones_cup.next.value
