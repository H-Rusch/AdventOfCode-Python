...
def parse_input():
    with open("input.txt", "r") as file:
        samples, instructions = file.read().split("\n\n\n\n")

        return samples, instructions


if __name__ == "__main__":
    sample_list, instruction_list = parse_input()

    print(f"Part 1: {part_1(sample_list)} samples behave like 3 or more opcodes.")

    print(f"Part 2: The value in register 0 after executing all instructions is {part_2(instruction_list)}.")
