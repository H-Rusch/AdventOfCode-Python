...
def part_1(instructions: list, bound: int) -> int:
    computer = Device([0, 0, 0, 0, 0, 0], bound, instructions)
    computer.run()
...
if __name__ == "__main__":
    bound_register, instruction_list = parse_input()

    print(f"Part 1: The value left in register 0 is {part_1(instruction_list, bound_register)}.")

    print(f"Part 2: The value left in register 0 is {part_2()}.")
