...
if __name__ == "__main__":
    ...
    print(f"Part 1: The scores of the 10 recipes after <{puzzle_input}> recipes is {part_1(int(puzzle_input))}.")

    print(f"Part 2: {part_2(puzzle_input)} recipes appear to the left of the score sequence when <{puzzle_input}> is found.")
