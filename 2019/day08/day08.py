...
def part1(image_layers: list) -> int:
...
if __name__ == "__main__":
    layer_list = parse(input)

    print(f"Part 1: The number of 1s * the number of 2s in the layer with the fewest 0s is {part1(layer_list)}.")
